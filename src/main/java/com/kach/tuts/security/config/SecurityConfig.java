package com.kach.tuts.security.config;

import com.kach.tuts.security.auth.ApplicationUserService;
import com.kach.tuts.security.jwt.JwtConfig;
import com.kach.tuts.security.jwt.JwtTokenVerifierFilter;
import com.kach.tuts.security.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
//                .addFilter(new JwtTokenVerifier(secretKey, jwtConfig))
